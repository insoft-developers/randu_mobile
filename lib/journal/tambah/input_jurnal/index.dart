...
class _InputJurnalState extends State<InputJurnal> {
  ...
  final List<TextEditingController> _catatan = [TextEditingController()];
  ...
  _onSubmit() {
    ...
    for (var i = 0; i < _debits.length; i++) {
      ...
      _catatanText.add(_catatan[i].text);
    }

    _inputJurnalController.saveMultipleJournal(
        _tanggal.text,
        _transName.text,
        _selectedAkuns,
        _debetText,
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Jarak(tinggi: 5),
            GetBuilder<InputJurnalController>(builder: (builderController) {
