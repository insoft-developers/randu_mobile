...
class PengaturanModalAwalController extends GetxController {
  ...
  Future getDataJournal(String id) async {
    ...
    if (user != null) {
      ...
      var res = await Network().post(data, '/journal/pengaturan-modal-awal');
      var body = jsonDecode(res.body);
      if (body['success']) {
        journalLoading(false);
        journal.value = body['data'];
        journalList.value = body['detail'];
        journalDate.value = body['tanggal'];
      }
    }
  }
