...
class OpeningBalanceController extends GetxController {
  ...
  void generateOpeningBalance() async {
    loading(true);
    ...
    if (user != null) {
      ...
      var res = await Network().post(data, '/journal/generate-opening-balance');
