...
class NeracaWebview extends StatefulWidget {
  String paymentUrl;
  NeracaWebview({Key? key, required this.paymentUrl}) : super(key: key);

  @override
  State<NeracaWebview> createState() => _NeracaWebviewState();
}

class _NeracaWebviewState extends State<NeracaWebview> {
