...
class ProfitLossWebview2 extends StatefulWidget {
  String paymentUrl;
  ProfitLossWebview2({Key? key, required this.paymentUrl}) : super(key: key);

  @override
  State<ProfitLossWebview2> createState() => _ProfitLossWebview2State();
}

class _ProfitLossWebview2State extends State<ProfitLossWebview2> {
