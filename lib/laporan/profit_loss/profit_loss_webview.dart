...
import 'package:randu_mobile/laporan/profit_loss/profit_loss_webview2.dart';
import 'package:randu_mobile/utils/constant.dart';
import 'package:shared_preferences/shared_preferences.dart';

// ignore: must_be_immutable
class ProfitLossWebview extends StatefulWidget {
  String paymentUrl;
  ProfitLossWebview({Key? key, required this.paymentUrl}) : super(key: key);

  @override
  State<ProfitLossWebview> createState() => _ProfitLossWebviewState();
}

class _ProfitLossWebviewState extends State<ProfitLossWebview> {
  ProfitLossController _laporan = Get.put(ProfitLossController());
  double _progress = 0;
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
            ...
            onPressed: () async {
              ...
              if (user != null) {
                var userId = user['id'];
                _showSimpleModalDialog(context, userId.toString());
              }
            }),
      ),
      key: scaffoldKey,
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.back();
                      Get.back();
                      Get.to(() => ProfitLossWebview2(
                          paymentUrl: Constant.BASE_URL +
                              'profit-loss-webview/$userId/${_laporanController.thisMonth.value}/${_laporanController.thisYear.value}/${_laporanController.thisMonthTo.value}/${_laporanController.thisYearTo.value}'));
                    },
                    child: Center(
                      child: Container(
